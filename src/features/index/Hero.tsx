...
const Hero: FC = (): ReactElement => {
  ...
  return (
    <div className="relative bg-white pb-20 pt-40 dark:bg-gray-900 lg:pt-44">
      <div className=" m-auto px-6 xl:container md:px-12 lg:px-6 flex-col flex justify-center items-center">
        ...
        <div className="lg:flex flex-col justify-center items-center">
          <div className="relative mt-8 space-y-8 text-center sm:mx-auto  md:mt-16 lg:ml-0 lg:mr-auto  lg:text-left">
            <p className="text-gray-700 dark:text-gray-300 sm:text-lg lg:w-11/12 text-center">
